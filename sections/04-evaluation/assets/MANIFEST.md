...
- `turbo-telefuser.mp4`: Regenerated TeleFuser FP8 Turbo LoRA output using the same ramen prompt, image, seed, and four-GPU setup as the comparison render; this quality-matched clip uses the pre-smoothing FP8 Sol setting (smoothing=none).

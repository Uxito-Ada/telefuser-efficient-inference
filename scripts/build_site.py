...
EDITIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": "Q-SPA combines quality-aware FP8, sparse attention, adapters, and multi-GPU execution for world models with TeleFuser.",
        "title": "Q-SPA: Efficient World Model Inference with TeleFuser",
        "system_label": "System",
        ...
        "footer": "Q-SPA | Efficient World Model Inference with TeleFuser",
    ...
    },
    {
        ...
        "description": "Q-SPA 使用 TeleFuser 组合面向世界模型的高质量 FP8、稀疏注意力、Adapter 与多 GPU 执行。",
        "title": "Q-SPA：使用 TeleFuser 的高效世界模型推理",
        "system_label": "优化方案",
